...
![](https://tva1.sinaimg.cn/large/e6c9d24egy1h6dhktjapzj20hs0b4wg5.jpg)
...
**Client**：客户端
## 类图
![](https://tva1.sinaimg.cn/large/e6c9d24egy1h6dhmp35f7j21eg0mkq3l.jpg)
...
* 美团在[外卖营销业务](https://tech.meituan.com/2020/03/19/design-pattern-practice-in-marketing.html)中资源位展示的逻辑
## 应用
...
**责任链模式其实就是一个灵活版的 if…else…语句**，它就是将这些判定条件的语句放到了各个处理类中，这样做的优点是比较灵活了，但同样也带来了风险，比如设置处理类前后关系时，一定要特别仔细，搞对处理类前后逻辑的条件判断关系，并且**注意不要在链中出现循环引用**的问题。
